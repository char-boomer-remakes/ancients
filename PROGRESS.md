...
| G2 | All §6 tests pass; `npm test` + `npm run build` green | IN PROGRESS (M1–M9 green; 758 tests) |
| G3 | Full playthrough: new game → all 8 badges → four raids → Elite Five → Champion, no blockers | OPEN → M10 |
| G4 | `PROGRESS.md` reconciled to the standalone bar; demo (§8) + perf numbers recorded | IN PROGRESS (perf numbers recorded M9; full demo/reconciliation → M10) |

import type { BossDef, CreepDef, DraftDef, DungeonDef, GymDef, HeroDef, ItemDef, NeutralItemDef, RaidDef, RecruitmentQuestDef, RegionDef, TrainerDef, TrialDef } from './types';

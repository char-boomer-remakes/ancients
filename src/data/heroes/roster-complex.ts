...
export const COMPLEX_MISSING_HEROES: HeroDef[] = [
  ...
  hero({
    ...
    abilities: [
      ...
      { id: 'techies-proximity-mines', name: 'Proximity Mines', targeting: 'ground-aoe', ult: true, castRange: 900, castPoint: 0.45, manaCost: [110, 140, 170], cooldown: [28, 22, 16], values: { damage: [280, 420, 560], radius: [360, 390, 420], duration: [20, 24, 28] }, effects: [{ kind: 'exotic', id: 'remote-mines', params: { heroId: 'techies' } }], vfx: vfx('ground-aoe', '#ff8a2f', '#f0f060') }
    ]
  })
];

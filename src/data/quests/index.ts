...
const HERO_REGION: Record<string, string> = {
  ...
  abaddon: 'shadeshore',
  alchemist: 'vile-reaches',
  bristleback: 'vile-reaches',
  dawnbreaker: 'tranquil-vale',
  'dragon-knight': 'shadeshore',
  huskar: 'vile-reaches',
  mars: 'shadeshore',
  'ogre-magi': 'icewrack',
  'primal-beast': 'vile-reaches',
  'spirit-breaker': 'mount-joerlak',
  underlord: 'vile-reaches',
  'anti-mage': 'quoidge',
  bloodseeker: 'vile-reaches',
  clinkz: 'mad-moon-crater',
  gyrocopter: 'shadeshore',
  hoodwink: 'hidden-wood',
  razor: 'mount-joerlak',
  'templar-assassin': 'quoidge',
  'troll-warlord': 'shadeshore',
  ursa: 'mount-joerlak',
  venomancer: 'devarshi-desert',
  weaver: 'mad-moon-crater',
  'death-prophet': 'vile-reaches',
  disruptor: 'mount-joerlak',
  grimstroke: 'quoidge',
  'keeper-of-the-light': 'quoidge',
  leshrac: 'quoidge',
  necrophos: 'vile-reaches',
  puck: 'hidden-wood',
  pugna: 'quoidge',
  'queen-of-pain': 'quoidge',
  'shadow-demon': 'vile-reaches',
  'shadow-shaman': 'icewrack',
  bane: 'nightsilver-woods',
  batrider: 'hidden-wood',
  clockwerk: 'quoidge',
  'dark-seer': 'mount-joerlak',
  'dark-willow': 'hidden-wood',
  dazzle: 'vile-reaches',
  'earth-spirit': 'mount-joerlak',
  enigma: 'mad-moon-crater',
  'lone-druid': 'hidden-wood',
  lycan: 'hidden-wood',
  marci: 'tranquil-vale',
  pangolier: 'mount-joerlak',
  snapfire: 'shadeshore',
  timbersaw: 'hidden-wood',
  'void-spirit': 'mad-moon-crater',
  'chaos-knight': 'mad-moon-crater',
  'arc-warden': 'mount-joerlak',
  meepo: 'mount-joerlak',
  'monkey-king': 'hidden-wood',
  morphling: 'shadeshore',
  'phantom-lancer': 'hidden-wood',
  rubick: 'quoidge',
  brewmaster: 'mount-joerlak',
  techies: 'vile-reaches',

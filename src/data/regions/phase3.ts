...
export const DEVARSHI_DESERT: RegionDef = {
  ...
  size: 12000,
  seed: 56031,
  lore: 'A buried kingdom of scarabs, mirages, and star-metal where the Burrow Badge is struck under the sand.',
...
export const SHADESHORE: RegionDef = {
  ...
  size: 12000,
  seed: 61002,
  lore: 'A black-sand coast of captains, reef guards, and drowned echo bells.',
...
export const VILE_REACHES: RegionDef = {
  ...
  size: 12000,
  seed: 77111,
  lore: 'A badland of rot engines and bone fires where the fifth badge is earned in the stink.',
...
export const QUOIDGE: RegionDef = {
  ...
  size: 12000,
  seed: 82004,
  lore: 'A city of disputing towers where spell theory is tested in alleys and arenas.',
...
export const HIDDEN_WOOD: RegionDef = {
  ...
  size: 12000,
  seed: 91337,
  lore: 'A deep jungle where every neutral camp has an opinion and every summoner tries to recruit it.',
...
export const MOUNT_JOERLAK: RegionDef = {
  ...
  size: 12000,
  seed: 100404,
  lore: 'A highland of horns, cliff echoes, and Titan Badge trials.',
...
export const MAD_MOON_CRATER: RegionDef = {
  ...
  size: 14000,
  seed: 120026,
  lore: 'The endgame crater. Roshan waits below; the Tower of the Ancients waits above.',
